...
function ProfileEdit(props) {
    ...
    return (
        <div className="flex justify-center bg-gradient-to-r from-purple-500 to-pink-500 min-h-screen">
            <div className='mt-12 w-4/5 sm:w-3/5'>
                <form className="bg-white overflow-hidden shadow rounded-lg border w-full">
                    ...
                    <div className='text-right py-3 px-5'>
                        <button onClick={(event) => props.save(event)} className='bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:bg-gradient-to-r from-purple-300 to-pink-300 font-bold py-2 px-8 rounded-md transition duration-300 ease-in-out' >Save</button>
                    </div>
                </form>
