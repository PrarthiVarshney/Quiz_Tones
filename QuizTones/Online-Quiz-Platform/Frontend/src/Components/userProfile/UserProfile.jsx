          ...
          <div className='mt-12 w-4/5 sm:w-3/5'>
            <div className="bg-white overflow-hidden shadow rounded-lg border w-full">
              ...
              <div className='text-right py-3 px-5'>
                <button onClick={() => setEdit(true)} className='bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:bg-gradient-to-r from-purple-200 to-pink-200 font-bold py-2 px-8 rounded-md transition duration-300 ease-in-out' >Edit</button>
              </div>
            </div>
