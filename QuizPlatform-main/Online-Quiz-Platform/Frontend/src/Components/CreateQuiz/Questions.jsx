        ...
        <div className='min-h-screen flex justify-center w-full'>
            <div className='my-10 item justify-center w-2/3'>
                ...
                <div className='flex flex-wrap justify-center sm:justify-between'>
                    ...
                    <button onClick={handleQuizEdit} className="py-0 px-8 text-sm font-medium text-center text-white bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg hover:bg-gradient-to-r from-purple-700 to-pink-700 focus:ring-4 focus:outline-none focus:ring-blue-300">Edit</button>
                </div>
                        ...
                        <div className="p-6 flex flex-col bg-white border border-gray-200 rounded-lg shadow m-2 w-full" key={index}>
                            ...
                            <div className='flex flex-wrap gap-1 sm:gap-0  sm:flex-nowrap justify-center sm:flex-none sm:justify-end sm:text-right'>
                                <div>
                                    ...
                                    <button onClick={(event) => navigateEdit(event, quizData.questions[index]._id)} className="inline-flex items-center px-6 py-2 text-sm font-medium text-center text-white bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg hover:bg-gradient-to-r from-purple-700 to-pink-700 focus:ring-4 focus:outline-none focus:ring-blue-300">Edit</button>
                                </div>
                                <div>
                                    <button onClick={(event) => handleDelete(event, quizData.questions[index]._id)} className="inline-flex items-center mx-4 px-6 py-2 text-sm font-medium text-center text-white bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg hover:bg-gradient-to-r from-purple-700 to-pink-700 focus:ring-4 focus:outline-none focus:ring-blue-300">Delete</button>
                                </div>
                            </div>
                        </div>
                    )
                ...
                <div className='flex justify-center'>
                    <button onClick={addQuestion} className="w-40 items-center px-6 py-2 text-sm font-medium text-center text-white bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg hover:bg-gradient-to-r from-purple-700 to-pink-700 focus:ring-4 focus:outline-none focus:ring-purple-300">Add Question</button>
                </div>
                <div className='flex justify-center'>
                    <Link to='/' className="w-40 my-4 items-center px-6 py-2 text-sm font-medium text-center text-white bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg hover:bg-gradient-to-r from-purple-600 to-pink-600 focus:ring-4 focus:outline-none focus:ring-purple-300">Save Quiz</Link>
                </div>
            </div>
            <ToastContainer />
        </div >
