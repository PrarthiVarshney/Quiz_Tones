...
function Login() {
  ...
  return (
    <>
      <section className="bg-gradient-to-r from-purple-300 to-pink-300 ">
        <div className="flex flex-col items-center justify-center px-2  mx-auto my-auto  md:h-screen lg:py-0">
          <div className="bg-gradient-to-r from-purple-500 to-pink-500 w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 ">
