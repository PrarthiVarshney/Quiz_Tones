        ...
        <>
            <div className='min-h-screen'>
                {showResult ? (
                    ...
                    <>
                        <div className='text-center m-4 text-white bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg'>Timer :{timer == 0 || timer ? timer : " "} seconds</div>
                        <div action='' className='flex justify-center my-4'>
                            <div className='w-full max-w-screen-md h-full flex flex-col justify-center items-center gap-2 p-4'>
                                ...
                                {quizData && (
                                    <div className='w-full border-2 rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 p-5'>
                                        ...
                                        <div className='flex flex-col gap-2'>
                                            {quizData.options.map((option, index) => (
                                                <div className='flex items-center ' key={index} >
                                                    ...
                                                    <button className={`w-full border rounded-md h-10 mb-4 text-center text-md text-white ${selectedOption == index ? "bg-gradient-to-r from-purple-500 to-pink-500 border-none" : null
                                                        }  hover:bg-gradient-to-r from-purple-400 to-pink-400 hover:border-none`}
                                        ...
                                        <div className='text-center'>
                                            <button
                                                ...
                                                className='bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-r from-purple-400 to-pink-400 text-white font-bold py-2 px-4 rounded-md transition duration-300 ease-in-out'>
                                                Next
                                            </button>
                                        </div>
                                    </div>
