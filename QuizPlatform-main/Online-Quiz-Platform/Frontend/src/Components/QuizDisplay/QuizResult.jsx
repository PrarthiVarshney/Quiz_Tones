            ...
            <div className='flex justify-center'>
                <div className="sm:w-9/12 md:w-2/5 p-6 bg-white border border-gray-200 rounded-lg shadow my-24">
                    ...
                    <div className='text-center'>
                        ...
                        <button onClick={props.saveResults} className="inline-flex items-center mt-4 px-3 py-2 text-sm font-medium text-center text-white bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg hover:bg-gradient-to-r from-purple-300 to-pink-300 focus:ring-4 focus:outline-none focus:ring-bg-gradient-to-r from-purple-300 to-pink-300">
                            Save Result
                        </button>
                    </div>
                </div>
